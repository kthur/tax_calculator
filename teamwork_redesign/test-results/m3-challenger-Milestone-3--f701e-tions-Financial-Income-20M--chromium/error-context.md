...
- Name: m3-challenger.spec.js >> Milestone 3 UI input data parsing and validation tests >> 2. Compared tax calculations (Financial Income > 20M)
- Location: tests\m3-challenger.spec.js:58:3

# Error details

```
Error: page.evaluate: TypeError: Cannot read properties of undefined (reading 'calculateComprehensiveIncome')
    at eval (eval at evaluate (:303:30), <anonymous>:3:35)
