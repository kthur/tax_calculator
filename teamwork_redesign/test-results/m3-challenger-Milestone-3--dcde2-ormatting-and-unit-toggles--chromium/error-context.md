...
- Name: m3-challenger.spec.js >> Milestone 3 UI input data parsing and validation tests >> 4. State persistence (Formatting and unit toggles)
- Location: tests\m3-challenger.spec.js:113:3

# Error details

```
Error: page.evaluate: TypeError: Cannot read properties of null (reading 'closest')
    at eval (eval at evaluate (:303:30), <anonymous>:3:27)
